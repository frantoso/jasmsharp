...
public abstract class Event : IEvent
{
    ...
    public IEvent ToDataEvent<TData>(TData data) =>
        typeof(Event).GetMethod(nameof(CreateDataEvent)) // Get the CreateDataEvent method from Event class
...
/// <summary>
///     Special event used to create transitions having no event in the state diagram.
/// </summary>
/// <seealso cref="jasmsharp.Event" />
public class NoEvent : Event;

/// <summary>
///     Special event used to start the state machine.
/// </summary>
/// <seealso cref="jasmsharp.Event" />
