...
public abstract class Fsm
{
    ...
    /// <returns>Returns true if the event was handled; false otherwise. In the case of asynchronous processing, it returns true.</returns>
    ...
    public interface IDebug
    {
        ...
        /// <summary>
        /// Triggers a transition synchronously. Independent of the concrete implementation, it calls the synchronous trigger function from the base class.
        /// </summary>
        /// <param name="event">The event occurred.</param>
    ...
    /// <summary>
    /// Gets an object implementing the debug interface. This allows access to special functions which are mainly provided for tests.
    /// </summary>
